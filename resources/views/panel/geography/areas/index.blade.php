        ...
        <div class="card-header bg-white border-bottom py-3 py-md-3 px-2 px-md-4">
            <form action="{{ route('areas.index') }}" method="GET">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-2">
                        <select name="country_id" class="form-select select-dropdown" id="search_country_id">
                ...
                <form action="{{ route('areas.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select modal-select-dropdown" id="country_id" name="country_id" required>
