                    ...
                    <div class="card shadow border-0 text-center">
                        <div class="card-body">
                            @if ($vendor->logo_url != null)
                                <img src="{{ $vendor->logo_url }}" alt="Logo Image" 
                                    style="object-fit:cover; cursor:pointer;"
                                    data-bs-toggle="modal"
                                    data-bs-target="#imageModal"
                                    onclick="showImage('{{ $vendor->logo_url }}')"
                            ...
                            <div class="d-flex align-items-center mb-4">
                                ...
                                @if($vendor->user->profile_url)
                                    <img src="{{ $vendor->user->profile_url }}"
                                        ...
                                        data-bs-toggle="modal"
                                        data-bs-target="#imageModal"
                                        onclick="showImage('{{ $vendor->user->profile_url }}')">
                                @endif
                                            ...
                                            <div class="card-body">
                                                ...
                                                @if($vendor->aadhar_front_url)
                                                    ...
                                                    <img src="{{ $vendor->aadhar_front_url }}"
                                                        ...
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#imageModal"
                                                        onclick="showImage('{{ $vendor->aadhar_front_url }}')">
                                            ...
                                            <div class="card-body">
                                                ...
                                                @if($vendor->aadhar_back_url)
                                                    ...
                                                    <img src="{{ $vendor->aadhar_back_url }}"
                                                        ...
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#imageModal"
                                                        onclick="showImage('{{ $vendor->aadhar_back_url }}')">
                                            ...
                                            <div class="card-body">
                                                ...
                                                @if($vendor->pan_card_url)
                                                    ...
                                                    <img src="{{ $vendor->pan_card_url }}"
                                                        ...
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#imageModal"
                                                        onclick="showImage('{{ $vendor->pan_card_url }}')">
